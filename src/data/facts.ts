...
export const facts: Fact[] = [
    ...
    },
    {
        ...
        details:
            `Mongol Shobhajatra is one of the most vibrant and meaningful cultural processions in Bangladesh, held every year on Pohela Boishakh, the Bengali New Year.
...
`Sakrain, also known as the Kite Festival of Bangladesh, is one of the oldest traditional festivals celebrated mainly in Old Dhaka. It takes place every year on January 14, marking the end of the Bengali month Poush and celebrating the transition of the sun—similar to harvest festivals in many cultures.
...
`Baul is a unique and spiritual folk tradition of Bangladesh, known for its music, philosophy, and way of life. Bauls are wandering minstrels who travel from village to village, singing songs that explore the meaning of life, love, and the human soul.
...
Human connection and inner peace are what truly matter.`



`Jatra is a traditional form of folk theatre in Bangladesh, known for its dramatic storytelling, powerful dialogues, and musical performances. It is one of the most popular forms of rural entertainment and has been enjoyed for generations across the country.
...
Moral lessons about good vs evil
👥 Performance Style
...
`Jamdani is one of the most exquisite and historically rich traditional textiles of Bangladesh. It is a type of finely handwoven fabric, most famous as the elegant Jamdani saree, known for its delicate patterns and airy texture.
...
`Dhakai Muslin is one of the most famous and luxurious fabrics in history, originating from the region of Dhaka in Bangladesh. It was once known as the finest cotton textile in the world, admired for its невероятно soft, light, and almost transparent quality.
...
`
Rickshaw Art is one of the most colorful and unique forms of folk art in Bangladesh, turning everyday cycle rickshaws into moving pieces of art.
...
`Nakshi Kantha is a traditional embroidered quilt from Bangladesh, created by rural women using layers of old sarees and cloth. More than just a piece of fabric, it is a beautiful form of storytelling through stitches.
...
🐅 They are excellent swimmers, adapted to the watery environment
...
The Sundarbans is not just a forest—it is a natural wonder and ecological treasure. It protects coastal areas from storms and supports thousands of species.
...
`
The Sundarbans is the largest mangrove forest on Earth, located in the southern part of Bangladesh, where major rivers meet the Bay of Bengal.
...
👥 Life Around the Sundarbans

Many local communities depend on the forest for their livelihood. People collect:

🍯 Honey
🐟 Fish
🌿 Forest resources

Their lives are closely connected to the rhythms of nature.

❤️ Why it matters

The Sundarbans is not just a forest—it is a lifeline for nature and people. It represents the beauty, resilience, and importance of protecting our environment.
`

`
Bangladesh is often called the “Land of Rivers” because it is crisscrossed by more than 700 rivers. These rivers shape the country’s geography, culture, and daily life.
...
`
A Haor is a unique type of wetland ecosystem found in the northeastern region of Bangladesh. It is a bowl-shaped lowland area that transforms dramatically with the seasons.

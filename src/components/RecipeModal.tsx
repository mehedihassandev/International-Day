 ...
 * Features immersive slide-up animation and cultural aesthetics.
 */
            ...
            {isOpen && (
                <div className="fixed inset-0 z-[100] flex items-center justify-center md:p-6">
                    ...
                    >
                        ...
                        {/* Left: Image Section */}
                        <div className="relative w-full md:w-5/12 h-[35vh] md:h-full bg-bd-green/5 flex-shrink-0">
                            {recipe.image && (
                                <motion.img
                                    src={recipe.image}
                                    alt={recipe.title}
                        ...
                        <div className="flex-1 flex flex-col overflow-hidden">
                            ...
                            <div className="flex-1 p-6 md:p-10 lg:p-14 flex flex-col overflow-y-auto custom-scrollbar">
                                ...
                                {/* Bottom Action Bar */}
                                <div className="mt-12 pt-6 border-t-2 border-bd-green/10 flex flex-wrap items-center justify-between gap-4">
                                    <div className="flex items-center gap-3 text-gray-500 hover:text-bd-red transition-colors cursor-pointer group">
                                        ...
                                        <span className="text-sm font-black uppercase tracking-widest group-hover:text-bd-red transition-colors">Save</span>
                                    </div>
                                    <div className="flex items-center gap-3 text-gray-500 hover:text-bd-red transition-colors cursor-pointer group">
                                        ...
                                        <span className="text-sm font-black uppercase tracking-widest group-hover:text-bd-red transition-colors">Share</span>
                                    </div>
                                    <div className="flex items-center gap-3 text-gray-500 hover:text-bd-red transition-colors cursor-pointer group">
                                        <div className="w-10 h-10 rounded-xl bg-bd-red/5 group-hover:bg-bd-red group-hover:text-white flex items-center justify-center transition-all">
                                            <MapPin size={18} className="group-hover:scale-110 transition-transform" />
                                        </div>
                                        <span className="text-sm font-black uppercase tracking-widest group-hover:text-bd-red transition-colors">Origin</span>
                                    </div>
                                </div>
                            </div>
                        </div>
